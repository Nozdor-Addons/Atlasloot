...
---- Scourge Invasion
	...
	AtlasLoot_Data["HeadlessHorsemanWB"] = {
		...
		{ 16, 26960, "", "=q4=Жуткий шлем разрушения Всадника", "=ds=#s1#, #a1#"};
		{ 17, 26968, "", "=q4=Жуткий шлем возрождения Всадника", "=ds=#s1#, #a1#"};
		{ 18, 26944, "", "=q4=Жуткий шлем коварства Всадника", "=ds=#s1#, #a2#"};
		{ 19, 26928, "", "=q4=Укрепленный скверной шлем Всадника", "=ds=#s1#, #a3#"};
		{ 20, 26920, "", "=q4=Жуткий шлем мощи Всадника", "=ds=#s1#, #a4#"};
		{ 21, 26952, "", "=q4=Нерушимый жуткий шлем Всадника", "=ds=#s1#, #a4#"};

		{ 24, 26313, "", "=q4=Жуткий скакун Всадника без головы", "#e12#"};
		{ 25, 26314, "", "=q4=Пылающий скакун Всадника без головы", "#e12#"};
		{ 26, 26315, "", "=q4=Благословенный скакун Всадника без головы", "#e12#"};
		{ 27, 26312, "", "=q4=Леденящий душу скакун Всадника без головы", "#e12#"};

		Prev = "HeadlessHorseman";
--		Next = "HeadlessHorsemanWBTMOG";
		Back = "WORLDEVENTMENU";

	};	AtlasLoot_Data["HeadlessHorsemanWBTMOG"] = {
		{ 1, 49126, "", "=q4=The Horseman's Horrific Helm", "=ds=#s1#, #a4#"};
		{ 2, 49121, "", "=q4=Ring of Ghoulish Glee", "=ds=#s13#"};
		{ 3, 49123, "", "=q4=The Horseman's Seal", "=ds=#s13#"};
		{ 4, 49124, "", "=q4=Wicked Witch's Band", "=ds=#s13#"};
