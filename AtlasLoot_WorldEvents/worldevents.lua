...
---- Scourge Invasion
	...
	AtlasLoot_Data["Winterviel2"] = {
		...
		AtlasLoot_Data["Winterviel3"] = {
		{ 1, 58176, "", "=q4=Кольцо каменной стойки", "#s13#"};
		{ 2, 58174, "", "=q4=Кольцо закаленного ветерана", "#s13#"};
		{ 3, 58172, "", "=q4=Кольцо клятвы защитника", "#s13#"};
		{ 4,  58170, "", "=q4=Кольцо несокрушимого щита", "#s13#"};
		{ 5, 58173, "", "=q4=Кольцо верного стража", "#s13#"};
		{ 6, 58169, "", "=q4=Кольцо стража щита", "#s13#"};
		{ 7, 58171, "", "=q4=Кольцо опытного защитника", "#s13#"};
		{ 8, 58175, "", "=q4=Кольцо ледяной тени", "#s13#"};
		{ 9, 58157, "", "=q4=Кольцо морозной звезды", "#s13#"};
		{ 10, 58159, "", "=q4=Кольцо песни метели", "#s13#"};
		{ 11, 58158, "", "=q4=Кольцо зимнего чуда", "#s13#"};
		{ 12, 58156, "", "=q4=Кольцо снежного рассвета", "#s13#"};
		{ 13, 58160, "", "=q4=Кольцо ледяного обета", "#s13#"};
		{ 14, 58160, "", "=q4=Кольцо ледяного обета", "#s13#"};
		{ 15, 58161, "", "=q4=Кольцо морозного удара", "#s13#"};
		{ 16, 58164, "", "=q4=Кольцо ломающего льда", "#s13#"};
		{ 17, 58163, "", "=q4=Кольцо быстрого шторма", "#s13#"};
		{ 18, 58162, "", "=q4=Кольцо ледяной точности", "#s13#"};
		{ 19, 58167, "", "=q4=Кольцо стужи ветра", "#s13#"};
		{ 20, 58166, "", "=q4=Кольцо морозной точности", "#s13#"};
		{ 21, 58168, "", "=q4=Кольцо ледяного опыта", "#s13#"};
		{ 22, 58165, "", "=q4=Кольцо снежного клинка", "#s13#"};

		{ 24, 58217, "", "=q4=Акулостойкий гребнерог", "#e12#"};
		{ 25, 58215, "", "=q4=Калуакский гребнерог", "#e12#"};
		{ 26, 58218, "", "=q4=Скальный гребнерог", "#e12#"};
		{ 27, 58216, "", "=q4=Ледобродный гребнерог", "#e12#"};
		{ 28, 58212, "", "=q4=Клыкаррский глайдер", "#e12#"};
		{ 29, 58204, "", "=q4=Кит Рыбная Палочка", "#e12#"};
		{ 30, 58205, "", "=q4=Рыболов Мэй", "#e12#"};
		Prev = "Winterviel2";
		Back = "WORLDEVENTMENU";
	};
	...
	AtlasLoot_Data["HeadlessHorseman"] = {
		...
		Prev = "Halloween2";
		Next = "HeadlessHorsemanWB";
		Back = "WORLDEVENTMENU";
	};

	AtlasLoot_Data["HeadlessHorsemanWB"] = {
		{ 1, 26184, "", "=q4=Пылающий большой меч Всадника", "=ds=#h2#, #w10#"};
		{ 2, 26176, "", "=q4=Лютый клинок Всадника", "=ds=#h1#, #w10#"};
		{ 3, 26168, "", "=q4=Жуткий клинок Всадника", "=ds=#h1#, #w10#"};
		{ 4, 26248, "", "=q4=Тесак Алого Ордена", "=ds=#h1#, #w1#"};
		{ 5, 26208, "", "=q4=Лютый кинжал Всадника", "=ds=#h1#, #w4#"};
		{ 6, 26240, "", "=q4=Церемониальный кинжал Алого Ордена", "=ds=#h1#, #w4#"};
		{ 7, 26256, "", "=q4=Факел Алого Ордена", "=ds=#h4#"};
		{ 8, 26192, "", "=q4=Лютая эгида Всадника", "=ds=#h4#, #w8#"};
		{ 9, 26200, "", "=q4=Жуткая эгида Всадника", "=ds=#h4#, #w8#"};
		{ 10, 26216, "", "=q4=Большой посох Алого Ордена", "=ds=#h2#, #w9#"};
		{ 11, 26224, "", "=q4=Алебарда Алого Ордена", "=ds=#h2#, #w7#"};
		{ 12, 26232, "", "=q4=Мушкетон Алого Ордена", "#w5#"};

		{ 13, 26960, "", "=q4=Жуткий шлем разрушения Всадника", "=ds=#s1#, #a1#"};
		{ 14, 26968, "", "=q4=Жуткий шлем возрождения Всадника", "=ds=#s1#, #a1#"};
		{ 15, 26944, "", "=q4=Жуткий шлем коварства Всадника", "=ds=#s1#, #a2#"};

		{ 16, 26884, "", "=q4=Пылающий большой меч Всадника", "=ds=#h2#, #w10#"};
		{ 17, 26877, "", "=q4=Лютый клинок Всадника", "=ds=#h1#, #w10#"};
		{ 18, 26876, "", "=q4=Жуткий клинок Всадника", "=ds=#h1#, #w10#"};
		{ 19, 26892, "", "=q6=Тесак Алого Ордена", "=ds=#h1#, #w1#"};
		{ 20, 26852, "", "=q4=Лютый кинжал Всадника", "=ds=#h1#, #w4#"};
		{ 21, 26853, "", "=q4=Церемониальный кинжал Алого Ордена", "=ds=#h1#, #w4#"};
		{ 22, 26885, "", "=q4=Факел Алого Ордена", "=ds=#h4#"};
		{ 23, 26845, "", "=q4=Лютая эгида Всадника", "=ds=#h4#, #w8#"};
		{ 24, 26844, "", "=q4=Жуткая эгида Всадника", "=ds=#h4#, #w8#"};
		{ 25, 26868, "", "=q4=Большой посох Алого Ордена", "=ds=#h2#, #w9#"};
		{ 26, 26860, "", "=q4=Алебарда Алого Ордена", "=ds=#h2#, #w7#"};
		{ 27, 26869, "", "=q4=Мушкетон Алого Ордена", "#w5#"};

		{ 28, 26928, "", "=q4=Укрепленный скверной шлем Всадника", "=ds=#s1#, #a3#"};
		{ 29, 26920, "", "=q4=Жуткий шлем мощи Всадника", "=ds=#s1#, #a4#"};
		{ 30, 26952, "", "=q4=Нерушимый жуткий шлем Всадника", "=ds=#s1#, #a4#"};

		Prev = "HeadlessHorseman";
		Next = "HeadlessHorsemanWB2";
		Back = "WORLDEVENTMENU";

	};	AtlasLoot_Data["HeadlessHorsemanWB2"] = {

		{ 1, 26313, "", "=q4=Жуткий скакун Всадника без головы", "#e12#"};
		{ 2, 26314, "", "=q4=Пылающий скакун Всадника без головы", "#e12#"};
		{ 3, 26315, "", "=q4=Благословенный скакун Всадника без головы", "#e12#"};
		{ 4, 26312, "", "=q4=Леденящий душу скакун Всадника без головы", "#e12#"};
		Prev = "HeadlessHorsemanWB";
		Back = "WORLDEVENTMENU";
	};
